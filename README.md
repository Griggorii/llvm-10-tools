...
Одна из llvm привязок как пример

dpkg-shlibdeps: предупреждение: у пакета debian/gnome-control-center/usr/libexec/gnome-control-center-search-provider можно удалить бесполезную зависимость от libwayland-server.so.0
